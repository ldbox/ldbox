 ...
 * as what are used by the preload library (liblb),
 * but is executed without liblb library (outside of
 * the session)
 *
 * This file provides required, compatible global variables
 * and routines for direct linking to lbrdbd.
*/
...
int lb_global_vars_initialized__ = 1;
...
char *ldbox_binary_name = "[lbrdbd]";
char *ldbox_exec_name = "[lbrdbd]";
char *ldbox_real_binary_name = "[lbrdbd]";
char *ldbox_orig_binary_name = "[lbrdbd]";

char *ldbox_active_exec_policy_name = "[lbrdbd]";
char *ldbox_mapping_method = "";
